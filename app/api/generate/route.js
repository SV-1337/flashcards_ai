...
You should return in the following JSON format (in the next line, ensuring that you don't add any extra characters outside of the quotations. Do not add the token '`'):
{
  "flashcards":[
    {
